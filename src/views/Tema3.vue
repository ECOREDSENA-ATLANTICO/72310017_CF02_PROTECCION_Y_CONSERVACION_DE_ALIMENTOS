  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 Aseguramiento de la calidad alimentaria
    ...
    .row.justify-content-center.align-items-center.mb-3.fondo_2_4
      ...
      .col-md-8.mb-3
        p.mb-3 La comisión del Codex Alimentarius es el más alto organismo internacional en materia de normas de alimentación. La importancia del Codex Alimentarius para la protección de la salud de los consumidores fue subrayada por la Resolución 39/248 de 1985 de las Naciones Unidas; en dicha Resolución se adoptaron directrices para elaborar y reforzar las políticas de protección del consumidor.
        ...
        .cajon.bg-5.p-4.mb-3
          p.mb-0 La comisión del Codex Alimentarius, es el órgano competente para la compilación de normas, códigos de prácticas, directrices y recomendaciones que constituyen el Codex Alimentarius. Desde la primera publicación, el modo de funcionamiento Codex Alimentarius significa “Código de alimentación” y es la compilación de todas las normas, códigos de comportamientos, directrices y recomendaciones de la Comisión del Codex Alimentarius. La Comisión del Codex Alimentarius es el más alto organismo internacional en materia de normas de alimentación.
          ...
          .row.justify-content-around.align-items-center
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  h4.mb-1.text-naranja <em>Codex Alimentarius</em> 
                  p.text-small.mb-0.text-white Lo invitamos a visitar el siguiente el sitio Web, para conocer más sobre el <em>Codex Alimentarius</em>.
                .col-sm-auto
                  a.boton.color-acento-botones(href="https://www.portaldeinocuidad.com/web/que-es-el-haccp/" target="_blank")
                    span Ir al sitio
                    i.fas.fa-external-link-alt

    .row.align-items-center.justify-content-center.mb-3.ps-2(data-aos="zoom-in-down").fondo_2_4
      .col-md-8.mb-3
    ...
    .row.align-items-center.justify-content-center.mb-4
      .col-md-12.mb-4
        .titulo-sexto.color-acento-contenido.mb-2
            h5 Figura 3. 
            span Proceso para el trámite de una norma del <em>Codex Alimentarius</em>
    ...
    .tarjeta.tarjeta.fondo_1_2.p-4.slyder_1.bg-01.mb-5
      SlyderA(tipo="b")
        .tarjeta.bg-01.p-4
    ...
    p El Invima es el organismo encargado de vigilar y aplicar estas regulaciones. Se asegura de que las industrias alimentarias cumplan con los estándares establecidos, mediante inspecciones regulares y la implementación de normativas que protejan la salud pública.               

    .row.justify-content-center.mb-3
      h4.text-center.mb-4 Línea de tiempo de la legislación en Colombia 
      .col-lg-8.mb-4
        LineaTiempoD
          p(numero="1" titulo="1979") Ley 9 de 1979 establece el marco sanitario nacional.
          p(numero="2" titulo="1997") Decreto 3075 regula las condiciones sanitarias en establecimientos alimentarios.
          p(numero="3" titulo="2013") Resolución 2674 actualiza requisitos de BPM.
          p(numero="4" titulo="2015") Resolución 719 ajusta aspectos técnicos de la resolución anterior.
          p(numero="5" titulo="2021") Resolución 810 introduce nuevos criterios de etiquetado.
